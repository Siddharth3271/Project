...
ALLOWED_HOSTS = ['127.0.0.1', 'localhost', "cloud-ide-backend-o772.onrender.com"]
...
CHANNEL_LAYERS = {
    "default": {
        ...
        "CONFIG": {
            # In local dev, this points to your local Redis.
            # In production, you will change this to your Cloud Redis URL!
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:5173",
    "http://127.0.0.1:5173",
    "https://project-eta-three-43.vercel.app"
]
# If you want to allow all origins in development (less secure, but easier):
...
DEFAULT_FROM_EMAIL = f'CodeMate <{os.getenv("EMAIL_HOST_USER")}>'